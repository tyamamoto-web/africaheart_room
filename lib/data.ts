...
//  ①同席カバレッジ…会える55ペア中50ペアが同席。未同席5組は全て青空絡み。青空は15時退席で
//    午前2コマのみ在室。部屋割り上の最大は6名だが、ユーザー指定のヒィ↔青空入替でコマ①は
//    3名部屋(2名)・コマ②は4名部屋(3名)＝計5名と同席。青空以外は宿題/デュエット等で全員と同席。
//  ②各部屋の男女比を均等…全室に男女1名以上（女性のみ/ゲストのみ部屋なし）。部屋内|M-F|は
//    ほぼ0-1。3M1Fはコマ①A（ヒィ↔青空入替）・コマ③A（5M3Fを4/4に割る構造上不可避）・
//    コマ④A（よしのすけ↔じゅり入替）の3室。いずれも男女とも在室・ゲストのみ部屋なし。
...
export const defaultRotations: Record<string, Record<string, "A" | "B" | "C">> = {
  // コマ①(12:30-14:00) A:よしのすけ・くる・Take・ヒィ  B:シュウ・ハッシー・じゅり・リノ  C:しゃちょー・青空・すー
  //   ※ヒィ↔青空はユーザー指定で入替（青空が3名部屋Cへ移り同席1名減＝青空カバレッジ5）
  koma1: {
    "1": "A", "2": "A", "4": "A", "6": "A",
    "5": "B", "8": "B", "12": "B", "13": "B",
    "3": "C", "7": "C", "11": "C",
