...
// 夕方(17:00-20:00)は3コマ＝各2部屋(A/B・在室者減で4/4→4/3→3/2)。
...
//    ほぼ0-1。唯一コマ③Bのみ3M1F（コマ③=5M3Fを4/4に割る構造上ここだけ避けられない）。
//  ③ゲスト(すー/じゅり/リノ)のみの部屋を作らない。
export const defaultRotations: Record<string, Record<string, "A" | "B" | "C">> = {
  // コマ①(12:30-14:00) A:くる・Take・ハッシー・リノ  B:しゃちょー・シュウ・青空・じゅり  C:よしのすけ・ヒィ・すー
  koma1: {
    "2": "A", "4": "A", "8": "A", "13": "A",
    "3": "B", "5": "B", "7": "B", "12": "B",
    "1": "C", "6": "C", "11": "C",
  },
  // コマ②(14:00-15:00) A:よしのすけ・Take・青空・すー  B:くる・シュウ・ヒィ・リノ  C:しゃちょー・ハッシー・じゅり
  koma2: {
    "1": "A", "4": "A", "7": "A", "11": "A",
    "2": "B", "5": "B", "6": "B", "13": "B",
    "3": "C", "8": "C", "12": "C",
  },
  // コマ③(17:00-18:00) A:よしのすけ・シュウ・じゅり・リノ  B:くる・しゃちょー・Take・ヒィ
  koma3: {
    "1": "A", "5": "A", "12": "A", "13": "A",
    "2": "B", "3": "B", "4": "B", "6": "B",
  },
  // コマ④(18:00-19:00) A:Take・ヒィ・じゅり・リノ  B:よしのすけ・くる・しゃちょー
  koma4: {
    "4": "A", "6": "A", "12": "A", "13": "A",
    "1": "B", "2": "B", "3": "B",
  },
  // コマ⑤(19:00-20:00) A:よしのすけ・くる・じゅり  B:しゃちょー・リノ
  koma5: {
    "1": "A", "2": "A", "12": "A",
    "3": "B", "13": "B",
  },
