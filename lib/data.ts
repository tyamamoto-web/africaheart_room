...
export const nextEvent = {
  ...
  highlights: [
    ...
    { label: "諏訪湖花火大会", note: "打ち上げ花火500発の感動体験", tone: "gold" as const },
  ],
  // 当日のスケジュール（予定）。cost は「1人あたりの目安」。空文字は費用表示なし。
  // map: タップで地図アプリを開く検索クエリ（店名＋住所）。空なら地図リンクを出さない。
  schedule: [
    { time: "12:50", title: "集合", place: "JOYJOY 諏訪インター店 ロビー集合", cost: "", map: "カラオケJOYJOY 諏訪インター店 長野県諏訪市四賀1811-2" },
    { time: "13:00〜17:45", title: "カラオケ", place: "JOYJOY 諏訪インター店（10人・2部屋）", cost: "2,500円", map: "カラオケJOYJOY 諏訪インター店 長野県諏訪市四賀1811-2" },
    { time: "18:00〜19:30", title: "焼肉パーティー", place: "食べ放題 焼肉じゅーじゅー", cost: "5,000円", map: "" },
    { time: "19:30〜20:00", title: "移動・買い出し", place: "コンビニで各自、お酒・ジュース・おつまみを少量購入", cost: "", map: "" },
    { time: "20:00〜20:40", title: "花火大会", place: "諏訪湖岸公園（芝生で花火が間近）／20:30 打ち上げ", cost: "", map: "諏訪湖岸公園 長野県諏訪市" },
    { time: "21:00〜23:00", title: "カラオケバー", place: "カラオケバー・ミルユッテ（10人）", cost: "3,500円", map: "カラオケバー ミルユッテ 長野県諏訪市大手2丁目1-4 大津屋ビル2F" },
    { time: "23:05", title: "解散", place: "松本行 終電／上諏訪駅まで徒歩5分", cost: "", map: "上諏訪駅 長野県諏訪市" },
  ],
  feeNote: "料金はすべて1人あたりの目安です。",
  estimateTotal: "11,500円",
  estimateBridge: "上のスケジュール料金とお礼を合わせた目安です。",
  estimateNote:
    "あくまで予約前の概算です。お酒を飲む人・飲まない人や、料金込み以外の注文で一人あたりの金額は変わりますが、飲まない方はこの額より少なくなる見込みです。",
  driverThanks: "車を出してくれた方へお礼：1人 500円（この概算に含みます）",
