...
// ハッシー・青空欠席、なち参加。前半7名(4/3)・後半8名(4/4)。同席被りを最小化（最大2回・3回以上ゼロ）
export const defaultRotations: Record<string, Record<string, "A" | "B" | "C">> = {
  // コマ1  A:よし・くる・シュウ・yurino  B:しゃちょー・たけ・なち
  koma1: {
    "1": "A", "2": "A", "5": "A", "8": "A",
    "3": "B", "4": "B", "10": "B",
  },
  // コマ2  A:よし・くる・たけ・なち  B:しゃちょー・シュウ・yurino
  koma2: {
    "1": "A", "2": "A", "4": "A", "10": "A",
    "3": "B", "5": "B", "8": "B",
  },
  // コマ3  A:くる・シュウ・じゅり・なち  B:よし・しゃちょー・たけ・yurino
  koma3: {
    "2": "A", "5": "A", "9": "A", "10": "A",
    "1": "B", "3": "B", "4": "B", "8": "B",
  },
  // コマ4  A:よし・しゃちょー・シュウ・なち  B:くる・たけ・yurino・じゅり
  koma4: {
    "1": "A", "3": "A", "5": "A", "10": "A",
    "2": "B", "4": "B", "8": "B", "9": "B",
  },
