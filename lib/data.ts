...
// 折衷案：じゅり(後半のみ)を例外とし、残り7名は全員が一度は同室になる配置。最大同席3回。
export const defaultRotations: Record<string, Record<string, "A" | "B" | "C">> = {
  // コマ1  A:よし・しゃちょー・たけ・シュウ  B:くる・yurino・なち
  koma1: {
    "1": "A", "3": "A", "4": "A", "5": "A",
    "2": "B", "8": "B", "10": "B",
  },
  // コマ2  A:よし・たけ・yurino・なち  B:くる・しゃちょー・シュウ
  koma2: {
    "1": "A", "4": "A", "8": "A", "10": "A",
    "2": "B", "3": "B", "5": "B",
  },
  // コマ3  A:よし・くる・たけ・じゅり  B:しゃちょー・シュウ・yurino・なち
  koma3: {
    "1": "A", "2": "A", "4": "A", "9": "A",
    "3": "B", "5": "B", "8": "B", "10": "B",
  },
  // コマ4  A:しゃちょー・たけ・じゅり・なち  B:よし・くる・シュウ・yurino
  koma4: {
    "3": "A", "4": "A", "9": "A", "10": "A",
    "1": "B", "2": "B", "5": "B", "8": "B",
  },
