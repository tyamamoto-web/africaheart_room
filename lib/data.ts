...
//  ・同席の偏り抑制…小部屋の最多同室は4回＝よしのすけ×くる（コマ①②③⑤、コマ③はユーザー指定
//    のよしのすけ↔ヒィ入替で増。それ以外のペアは最多3回、じゅり×しゃちょーは手動固定④⑤の2回）。
//  ・きい(18:00退席)はコマ①でC(青空と同室)＝きい↔青空を確保し青空カバレッジも6へ回復。コマ④⑤は不在。
export const defaultRotations: Record<string, Record<string, "A" | "B" | "C">> = {
  // コマ①(12:30-14:00) A:よしのすけ・くる・ヒィ・すー  B:シュウ・ハッシー・じゅり・リノ  C:しゃちょー・Take・青空・きい
  //   ※ヒィ↔青空はユーザー指定で入替（ヒィ=A/青空=C）。きいはC(青空と同室)に追加＝きい↔青空を確保。
  //   　男女比均等化のためTake↔すーを調整し全室2M2Fに（青空カバレッジは6を維持）。
  koma1: {
    "1": "A", "2": "A", "6": "A", "11": "A",
    "5": "B", "8": "B", "12": "B", "13": "B",
    "3": "C", "4": "C", "7": "C", "14": "C",
  },
  // コマ②(14:00-15:00) A:シュウ・ヒィ・青空・じゅり  B:よしのすけ・くる・ハッシー・すー  C:しゃちょー・Take・リノ・きい
  koma2: {
    "5": "A", "6": "A", "7": "A", "12": "A",
    "1": "B", "2": "B", "8": "B", "11": "B",
    "3": "C", "4": "C", "13": "C", "14": "C",
  },
  // コマ③(17:00-18:00) A:しゃちょー・シュウ・ヒィ・リノ・きい  B:よしのすけ・くる・Take・じゅり
  //   ※よしのすけ↔ヒィはユーザー指定で入替（よしのすけ×くるが4コマ同室になるが他観点は維持）
  koma3: {
    "3": "A", "5": "A", "6": "A", "13": "A", "14": "A",
    "1": "B", "2": "B", "4": "B", "12": "B",
  },
