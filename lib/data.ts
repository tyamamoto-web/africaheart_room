...
// 宿題(15-16)・デュエット(16-17)は全員1部屋（青空/めぐ以外の全ペアはここで同席）。
//
// 3条件を同時達成するよう焼きなましで最適化（2026-07-20 再最適化）：
//  ①同席カバレッジ最大化…会える75ペア中73ペアが同席。未同席は青空↔くる/青空↔すーの
//    2組のみ（青空は15時退席で午前3コマ×4名＝最大9名までしか会えない物理的下限）。
//    めぐ↔よしのすけ含む他は全員が会える相手全員と同席。
...
export const defaultRotations: Record<string, Record<string, "A" | "B" | "C">> = {
  // コマ1  A:みや・よしのすけ・すー・Take  B:シュウ・ヒィ・くる・じゅり  C:しゃちょー・リノ・青空・ハッシー
  koma1: {
    "9": "A", "1": "A", "11": "A", "4": "A",
    "5": "B", "6": "B", "2": "B", "12": "B",
    "3": "C", "13": "C", "7": "C", "8": "C",
  },
  // コマ2  A:ハッシー・Take・リノ・じゅり  B:しゃちょー・よしのすけ・くる・すー  C:ヒィ・シュウ・みや・青空
  koma2: {
    "8": "A", "4": "A", "13": "A", "12": "A",
    "3": "B", "1": "B", "2": "B", "11": "B",
    "6": "C", "5": "C", "9": "C", "7": "C",
  },
  // コマ3  A:しゃちょー・ヒィ・リノ・すー  B:よしのすけ・Take・じゅり・青空  C:シュウ・ハッシー・くる・みや
  koma3: {
    "3": "A", "6": "A", "13": "A", "11": "A",
    "1": "B", "4": "B", "12": "B", "7": "B",
    "5": "C", "8": "C", "2": "C", "9": "C",
  },
  // コマ4  A:リノ・じゅり・よしのすけ・シュウ・めぐ  B:みや・くる・Take・ヒィ・しゃちょー
  koma4: {
    "13": "A", "12": "A", "1": "A", "5": "A", "10": "A",
    "9": "B", "2": "B", "4": "B", "6": "B", "3": "B",
  },
  // コマ5  A:Take・ヒィ・くる・めぐ・リノ  B:しゃちょー・よしのすけ・じゅり・みや
  koma5: {
    "4": "A", "6": "A", "2": "A", "10": "A", "13": "A",
    "3": "B", "1": "B", "12": "B", "9": "B",
  },
  // コマ6  A:みや・じゅり・しゃちょー・めぐ  B:よしのすけ・くる・リノ
  koma6: {
    "9": "A", "12": "A", "3": "A", "10": "A",
    "1": "B", "2": "B", "13": "B",
  },
