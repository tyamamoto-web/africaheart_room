        ...
        <div className="px-4 pt-5 pb-8 max-w-5xl mx-auto">
          ...
          >
            ...
            <div style={{ maxWidth: 660 }}>
              ...
              {/* ── 役員の役割と持ち味（リーダー・サブリーダー）──
                  みんなが納得して気持ちよく動けるように、決め方をオープンにするための分担。
                  責める・ルールで縛る書き方は避け、前向きな「こうできたら」の言い方で揃える。 */}
              ...
              <p style={{ marginTop: 6, fontSize: 11.5, color: "#a2988a", lineHeight: 1.7 }}>
                役員は、だれが上でだれが下という話ではなく、決めごとを気持ちよく前に進めるための役割分担です。リーダーが最後に決める役をもっているのは、意見が分かれたときに「じゃあこうしよう」と言える人がいると、みんなが安心して動けるから。最後に決めるときは「決める前にひとこと相談」と「決めたあとにみんなへ共有」をセットにすると、納得感が生まれます。大事な決めごとは、まず上の表で「責任者（1人）・相談役・お知らせ」を決めてから動きだすと、だれに聞けばいいか・だれに伝わるかがはっきりして、みんなが迷わず進めます。
              </p>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 12, marginTop: 12 }}>
                ...
                <div style={{ flex: "1 1 260px", minWidth: 240, border: "1px solid #eadfce", borderRadius: 12, background: "#fffdf9", padding: "13px 15px" }}>
                  ...
                  <ul style={{ margin: "9px 0 0", padding: 0, listStyle: "none", display: "grid", gap: 7 }}>
                    <li style={{ fontSize: 11.5, color: "#6f6757", lineHeight: 1.7 }}>
                      <b style={{ color: "#5c5646" }}>役割</b>：全体の向かう先をゆるやかにまとめて、意見が分かれたときに「こうしよう」と最後に決める役。ここがはっきりしていると、話が途中で止まらず、「これはみんなで決めたこと」だと安心して進めます。
                    </li>
                    <li style={{ fontSize: 11.5, color: "#6f6757", lineHeight: 1.7 }}>
                      <b style={{ color: "#5c5646" }}>できること</b>：みんなの声を聞いたうえで、最後に「これでいこう」と決められます。お金・ルール・体制のように影響の大きいことは、決める前にひとこと相談してから決めると、あとからみんなが気持ちよく動けます。
                    </li>
                    <li style={{ fontSize: 11.5, color: "#6f6757", lineHeight: 1.7 }}>
                      <b style={{ color: "#5c5646" }}>引き受けること</b>：決めたことの結果をいっしょに引き受けて、「どうしてそう決めたのか」を自分の言葉で話せること。理由が伝わると、みんなが納得して同じ方向を向けます。
                    </li>
                    <li style={{ fontSize: 11.5, color: "#6f6757", lineHeight: 1.7 }}>
                      <b style={{ color: "#b08948" }}>こんなふうに動けたら</b>：決める前にサブへひとこと相談する／ちがう意見ほどじっくり聞いてみる／決めた内容と理由をみんなに共有する／お願いしたことは信じてまかせる。チーム全体に安心感が生まれます。
                    </li>
                  </ul>
                </div>
                ...
                <div style={{ flex: "1 1 260px", minWidth: 240, border: "1px solid #eadfce", borderRadius: 12, background: "#fffdf9", padding: "13px 15px" }}>
                  ...
                  <ul style={{ margin: "9px 0 0", padding: 0, listStyle: "none", display: "grid", gap: 7 }}>
                    <li style={{ fontSize: 11.5, color: "#6f6757", lineHeight: 1.7 }}>
                      <b style={{ color: "#5c5646" }}>役割</b>：リーダーをそばで支えて、判断や負担を分かち合う役。メンバーの声をリーダーに届けたり、「こういう見方もあるよ」と別の角度を出したりできる役割です。
                    </li>
                    <li style={{ fontSize: 11.5, color: "#6f6757", lineHeight: 1.7 }}>
                      <b style={{ color: "#5c5646" }}>できること</b>：担当ごとに「責任者」や「やる人」になれます。そして、何かを決める前には意見を聞いてもらえる相談役です。「これで大丈夫かな」と思ったら、そのまま声に出してみてください。それがサブのいちばんの持ち味です。
                    </li>
                    <li style={{ fontSize: 11.5, color: "#6f6757", lineHeight: 1.7 }}>
                      <b style={{ color: "#5c5646" }}>引き受けること</b>：気づいたことを、決まる前に場に出すこと。早めにひとこと言っておくと、みんなが同じ景色を見ながら進めます。
                    </li>
                    <li style={{ fontSize: 11.5, color: "#6f6757", lineHeight: 1.7 }}>
                      <b style={{ color: "#b08948" }}>こんなふうに動けたら</b>：気になることや思いついた案は早めに共有する／メンバーの声を拾ってリーダーに届ける／決まったことは前向きに進めて、もっと良くできそうなら気軽に提案する。チームがどんどん良くなっていきます。
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <p style={{ marginTop: 11, fontSize: 11, color: "#a2988a", lineHeight: 1.7 }}>
                ※ 役割やできることは、えらい・えらくないの話ではなく、決めごとをオープンに進めて「みんなで決めた」と思えるようにするための分担です。迷ったときはお互いに助け合って、役員MTGで話しながら、その時々に合うかたちへ一緒に育てていきましょう。
              </p>
            </div>
