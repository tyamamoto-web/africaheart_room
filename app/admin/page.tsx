        ...
        <div className="px-4 pt-5 pb-8 max-w-5xl mx-auto">
          ...
          >
            ...
            <div style={{ maxWidth: 660 }}>
              ...
              <p style={{ marginTop: 6, fontSize: 11.5, color: "#a2988a", lineHeight: 1.7 }}>
                役員は上下の身分ではなく、決めごとを前に進めるための役割分担です。リーダーに最終決定権があるのは「意見が分かれたとき、最後に決める人が必要だから」であって、独断のためではありません。だから最終決定権は、いつも「決める前の相談」「決めた後の共有」とセットで考えます。下のめやすをふまえ、大事な決めごとは、まず上の表で「責任者（1人）・相談役（決める前に相談）・お知らせ（決めた後に共有）」を決めてから進めましょう。
              </p>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 12, marginTop: 12 }}>
                ...
                <div style={{ flex: "1 1 260px", minWidth: 240, border: "1px solid #eadfce", borderRadius: 12, background: "#fffdf9", padding: "13px 15px" }}>
                  ...
                  <ul style={{ margin: "9px 0 0", padding: 0, listStyle: "none", display: "grid", gap: 7 }}>
                    <li style={{ fontSize: 11.5, color: "#6f6757", lineHeight: 1.7 }}>
                      <b style={{ color: "#5c5646" }}>役割</b>：全体の方向をまとめ、意見が分かれたときに最後に決める人。決めごとを止めないため、そして「誰が決めたか」をはっきりさせるために置く役割です。
                    </li>
                    <li style={{ fontSize: 11.5, color: "#6f6757", lineHeight: 1.7 }}>
                      <b style={{ color: "#5c5646" }}>権限</b>：やることの「責任者」として最終決定できます。ただしこれは「一人で決めてよい」ではなく、「みんなの意見を聞いたうえで最後に決める」権限です。お金・ルール・体制など影響の大きいことは、必ず相談にかけてから決めます。
                    </li>
                    <li style={{ fontSize: 11.5, color: "#6f6757", lineHeight: 1.7 }}>
                      <b style={{ color: "#5c5646" }}>責任</b>：決めた結果を引き受けること、そして「なぜそう決めたか」を説明できること。権限と責任はセットです。
                    </li>
                    <li style={{ fontSize: 11.5, color: "#6f6757", lineHeight: 1.7 }}>
                      <b style={{ color: "#b08948" }}>あるべき姿</b>：決める前にサブへ相談する／反対意見ほど丁寧に聞く／決めた内容と理由を全員に共有する（密室にしない）／任せたら細かく口を出しすぎない。独断で決める・経緯を説明しない・立場で押し切る、は避けます。
                    </li>
                  </ul>
                </div>
                ...
                <div style={{ flex: "1 1 260px", minWidth: 240, border: "1px solid #eadfce", borderRadius: 12, background: "#fffdf9", padding: "13px 15px" }}>
                  ...
                  <ul style={{ margin: "9px 0 0", padding: 0, listStyle: "none", display: "grid", gap: 7 }}>
                    <li style={{ fontSize: 11.5, color: "#6f6757", lineHeight: 1.7 }}>
                      <b style={{ color: "#5c5646" }}>役割</b>：リーダーを支え、判断や負担が一人に集中しないようにする人。メンバーの声をリーダーに届け、決め方が偏らないか見守る役でもあります。
                    </li>
                    <li style={{ fontSize: 11.5, color: "#6f6757", lineHeight: 1.7 }}>
                      <b style={{ color: "#5c5646" }}>権限</b>：担当ごとに「責任者」や「やる人」になれます。決める前に必ず意見を求められる立場（相談役）で、「おかしい」と思ったら止めて問い直してよい——むしろそれが役目です。
                    </li>
                    <li style={{ fontSize: 11.5, color: "#6f6757", lineHeight: 1.7 }}>
                      <b style={{ color: "#5c5646" }}>責任</b>：気づいたことを、決まる前に場に出すこと。決まった後に蒸し返すのではなく、決める前に伝えるのがサブリーダーの責任です。
                    </li>
                    <li style={{ fontSize: 11.5, color: "#6f6757", lineHeight: 1.7 }}>
                      <b style={{ color: "#b08948" }}>あるべき姿</b>：懸念や案は早めに共有する／メンバーの声を吸い上げて届ける／決まったことは前向きに実行し、必要なら建設的に見直しを提案する。陰で不満を言うだけ・決める前に黙る、は避けます。
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <p style={{ marginTop: 11, fontSize: 11, color: "#a2988a", lineHeight: 1.7 }}>
                ※ 役割・権限は固定の身分ではなく、決め方を透明にして「独断」や「いつの間にか決まっていた」を防ぐための分担です。迷ったら助け合い、役員MTGで話しながら見直していきましょう。
              </p>
            </div>
