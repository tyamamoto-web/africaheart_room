...
/* ============================================================
   ...
   【9/6：TOPページへ移した】
     この画面は app/components/PresidentRoom.tsx ごとTOP（app/page.tsx）に出るようになった。
     下のほうに「本番の会員の画面には出さない」と書いてある「編集」、確認用の
     「準備・当日・ふりかえり」の切り替え、スマホの枠は、移した時点ではまだそのまま
     出している（外すかどうかはこれから決める）。
