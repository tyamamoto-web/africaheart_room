...
/* ============================================================
   参加者アンケート（中身）
   ------------------------------------------------------------
   9/6 に app/survey/page.tsx からそのまま切り出した（1文字も変えていない）。
   /survey と、設定 ＞ アンケート（TOPと、管理画面 ＞ 社長室 の両方）が
   どちらもこれを出す。どちらから書いても、答えは同じ1件になる（端末ごと）。
   ページの上のバー（TOPへ戻る・見出し）だけは app/survey/page.tsx に残してある。

   参加する方に、事前の確認と運営からのお願いへ答えてもらうところ。
