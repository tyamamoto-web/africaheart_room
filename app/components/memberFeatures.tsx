...
/* ============================================================
   ...
   5つ。会員メニュー（app/test/page.tsx）のタブと、管理画面 ＞ 社長室 ＞ 設定 の
   項目（app/components/PresidentFeature.tsx）は、どちらもこの並びをそのまま使う。
   id は URL の ?tab=<id>（TOPの部屋割り表からのリンク）と、社長室のメニューの
   項目の id（"m10-<id>"）に使っているので、名前を変えても id は変えないこと。
   ============================================================ */
